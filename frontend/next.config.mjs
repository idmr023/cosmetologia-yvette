...
const nextConfig = {
  ...
  async rewrites() {
    ...
    return [
      ...
      { source: "/api/appointments", destination: `${up}/api/appointments` },
      { source: "/api/appointments/:path*", destination: `${up}/api/appointments/:path*` },
      { source: "/api/clients", destination: `${up}/api/clients` },
      { source: "/api/clients/:path*", destination: `${up}/api/clients/:path*` },
      { source: "/api/services", destination: `${up}/api/services` },
      { source: "/api/services/:path*", destination: `${up}/api/services/:path*` },
      { source: "/api/colaboradores", destination: `${up}/api/colaboradores` },
      { source: "/api/colaboradores/:path*", destination: `${up}/api/colaboradores/:path*` },
      { source: "/api/inventory", destination: `${up}/api/inventory` },
